...
```{r}
hist(merged_aq_data$difference, main = paste("Difference of PM 25 Concentration between The Bronx and Williamsburg, NY", timeline_string), cex.main=.6, xlab = "Air Quality Index (AQI)", col="skyblue", breaks = 100)
```
