...
```{r}
hist(bronx_aq$value, main = paste("PM25 Concentration (µg/m³) in Bronx, NY", timeline_string), cex.main=.8, xlab = "Concentration µg/m³", col="skyblue", breaks = 100)
```

### II. Distribution of Particulate Matter Data in Williamsburg, NY

```{r}
hist(williamsburg_aq$value, main = paste("PM25 Concentration (µg/m³) in Williamsburg, NY", timeline_string), cex.main=.8, xlab ="Concentration µg/m³", col="salmon1", breaks = 100)
